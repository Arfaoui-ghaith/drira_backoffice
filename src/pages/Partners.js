...
export default function Role() {
	...
	const fetchPartners = async () => {
		try {
			const url ='https://spnetwork.herokuapp.com/api/v1/partners/';
    ...
    const deletePartner = async () => {
		try {
			const url =`https://spnetwork.herokuapp.com/api/v1/partners/${partner._id}`;
			const res = await axios({
								...
								<Table responsive>
									...
									{ partners.map((partn, index) => (
										<tr key={index}>
                                            ...
                                            <td>
                                                <img src={`https://spnetwork.herokuapp.com/images/partners/${partn.image}`} className="rounded" style={{"height": "60px"}} />
                                            </td>
                                            <td>
                                            	{partn.name}
                                            </td>
