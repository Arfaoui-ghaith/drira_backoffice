...
export default function Role() {
	...
	const fetchMembers = async () => {
		try {
			const url ='https://spnetwork.herokuapp.com/api/v1/team/';
    ...
    const deleteMember = async () => {
		try {
			const url =`https://spnetwork.herokuapp.com/api/v1/team/${member._id}`;
			const res = await axios({
								...
								<Table responsive>
									...
									{ members.map((memb, index) => (
										<tr key={index}>
                                            ...
                                            <td>
                                                <img src={`https://spnetwork.herokuapp.com/images/members/${memb.image}`} className="rounded" style={{"height": "70px"}} />
                                            </td>
                                            <td>
                                            	{memb.first_name}
                                            </td>
